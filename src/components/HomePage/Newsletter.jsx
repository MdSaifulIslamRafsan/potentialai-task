    ...
    return (
        <div className="max-w-xl text-center space-y-5 mx-auto">
            ...
            <form className="space-x-1 lg:space-x-3 flex">
               <input type="email" placeholder="Enter Your Email" className="py-3 border rounded-lg lg:px-5 px-2 flex-1 bg-white text-black" name="" id="" />
               <button href="/" className="btn px-2 md:px-6 bg-[#FD6F00] text-white">Contact Me </button>
            </form>
        </div>
    );
};
